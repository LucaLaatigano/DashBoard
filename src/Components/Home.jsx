...
const Home = () => {
    ...
    return (
        <div className="pl-13 pt-5 flex flex-wrap gap-5">
            <div className="w-60 h-50 bg-white rounded-2xl p-3">
                <div className='flex justify-between'>
                    <div>
                        <label className='font-bold text-xl pl-3 text-gray-800'>Total Sales</label>
            ...
            <div className="w-60 h-50 bg-white rounded-2xl p-3 flex flex-col gap-8">
                <div className='flex justify-between'>
                    <div className="flex flex-col">
                        <label className='font-bold text-2xl pl-3 mb-10 text-gray-800'>New Users</label>
            ...
            <div className="w-60 h-50 bg-white rounded-2xl flex flex-col gap-8 p-3">
                <div className='flex justify-between'>
                    <div className="flex flex-col">
                        <label className='font-bold text-2xl pl-3 mb-10 text-gray-800'>Active Projects</label>
            ...
            <div className="w-60 h-50 bg-white rounded-2xl flex flex-col gap-8 p-3">
                <div className='flex justify-between'>
                    <div className="flex flex-col">
                        <label className='font-bold text-2xl pl-3 mb-10 text-gray-800'>Server Uptime</label>
                        <h3 className="text-3xl font-bold pl-3 text-gray-800">99.98%</h3>
                    </div>
                </div>
            ...
            <div className="flex gap-10 mt-5">
                <div className="w-180 h-95 bg-white rounded-2xl p-3">
                ...
                <div className="w-65 h-95 p-3 bg-white rounded-2xl">
                    <label className='font-bold text-2xl pl-3 mb-10 text-gray-800'>Recent Activity</label>
                    <div className='flex flex-col gap-5 mt-5 pl-3'>
                        {users.slice(0, 5).map(user => (
                            <div key={user.id} className='w-full h-11 flex gap-3'>
                                ...
                                <div className='flex flex-col'>
                                    <span className="font-medium text-gray-900 truncate w-48">
                                        {user.name}
                                    </span>
                                    <span className="font-light text-sm text-gray-400 truncate w-48">
                                        {faker.helpers.arrayElement(possibleActions)}
                                    </span>
                                </div>
                            </div>
                        ))}
