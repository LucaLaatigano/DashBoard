...
const Home = () => {
    ...
    return (
        <div className="w-full lg:pl-13 lg:pt-5 flex flex-wrap gap-5 p-4">
            <div className="w-full flex-1 min-w-[230px] h-50 bg-white rounded-2xl p-3 shadow-sm mr-2">
            ...
            <div className="w-full flex-1 min-w-[230px] h-50 bg-white rounded-2xl p-3 flex flex-col gap-8 shadow-sm mr-2">
                <div className='flex justify-between'>
            ...
            <div className="w-full flex-1 min-w-[230px]  h-50 bg-white rounded-2xl flex flex-col gap-8 p-3 shadow-sm mr-2">
                <div className='flex justify-between'>
                    <div className="flex flex-col">
            ...
            <div className="w-full flex-1 min-w-[230px]  h-50 bg-white rounded-2xl flex flex-col gap-5 p-3 shadow-sm mr-2">
                <div className='flex justify-between'>
                    <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-5 w-full mt-5 mr-2">
                <div className="w-full lg:w-[calc(70%-1.25rem)] h-95 bg-white rounded-2xl p-3 shadow-sm">
                ...
                <div className="w-full md:flex-1 lg:w-[30%] h-95 p-3 bg-white rounded-2xl shadow-sm">
