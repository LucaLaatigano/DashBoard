            ...
            <div className="flex flex-col lg:flex-row gap-6">
                <div className="mt-5 w-full lg:w-170 bg-white rounded-2xl">
                    ...
                    <div className="flex">
                        ...
                        <div className="flex flex-col mt-6 ml-6 gap-3">
                            <input type="file" ref={fileInputRef} onChange={handleFileChange} accept="image/*" className="hidden" />
                            <button
                                className="w-35 h-10 border-3 border-zinc-200 rounded-2xl text-blue-300 hover:cursor-pointer"
                                onClick={() => fileInputRef.current.click()}
                            >
                                Change Photo
                            </button>
                            <button
                                className="w-25 h-10 border-3 border-zinc-200 text-red-400 rounded-2xl hover:cursor-pointer"
                    ...
                    <div className="flex flex-col mt-5 ml-5 gap-3 pb-5">
                        <div className="flex flex-col">
                            <label className="block text-slate-900 font-light text-2xl">Full Name</label>
                            <input
                                type="text" name="fullName" value={formData.fullName} onChange={handleChange}
                                className="w-full max-w-xs h-12 mt-3 border-3 border-zinc-200 rounded-2xl pl-3 outline-none focus:bg-slate-900/10"
                            />
                        </div>
                        <div className="flex flex-col">
                        ...
                        <div className="flex justify-end mr-5">
                            <button
                                onClick={handleSave}
                                className="w-20 h-10 mt-1 border-3 border-zinc-200 rounded-2xl hover:cursor-pointer hover:bg-slate-900/10"
                            >
                                {isSaved ? "Saved" : "Save"}
                            </button>
                        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-5 w-full">
                    <div className="w-full bg-white rounded-2xl pl-3 pr-2 pb-4">
                        ...
                        <div className="flex gap-10 ml-3 mt-3">
                            ...
                            <label>Enable Two-Factor <br />Authentication</label>
                        ...
                        <Link to="/users">
                            <div className="flex gap-10 mt-7 ml-3 hover:cursor-pointer pt-3">
                    ...
                    <div className="w-full bg-white rounded-2xl pl-3 pr-2 pb-4 flex flex-col gap-3">
                        ...
                        <div className="flex flex-col pl-3">
                            ...
                            <h3 className="font-bold text-xl text-gray-800">Stored Credit Card Info</h3>
                        </div>
                        <div className="flex justify-end">
                            <button
                                onClick={handleReset}
                                className="w-35 h-10 border-2 border-red-500 text-red-400 hover:bg-zinc-100 hover:cursor-pointer rounded-2xl"
                            >
                                Delete Account
                            </button>
                        </div>
                        ...
                        <div className="flex flex-col ml-3">
                            ...
                            <div className="flex gap-3">
                                ...
                                <a
                                    ...
                                    className="font-light text-blue-600 text-xl hover:cursor-pointer"
                                >
                                    Load
                                </a>
                                <a href={formData.cv} download={formData.cv} className="font-light text-blue-600 text-xl">
                                    Download
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="w-full bg-white rounded-2xl pl-3 pr-2 pb-4 flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-6 mt-2">
                            <div className="ml-3 flex gap-10">
                                <label className="font-light text-xl">Newsletter</label>
                            ...
                            <div className="ml-3 flex gap-10">
                                <label className="font-light text-xl">Activity Mentions</label>
